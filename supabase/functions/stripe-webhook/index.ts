...
import { qualifyReferralFromPaidInvoice } from '../_shared/referrals.ts'
...
Deno.serve(async (request) => {
  ...
  try {
    ...
    if (event.type === 'invoice.paid') await qualifyReferralFromPaidInvoice(event.data.object as Stripe.Invoice, event.id)
