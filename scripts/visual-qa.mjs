...
try {
  ...
  check('demo route', page.url().endsWith('/deck'))
  ...
  await page.goto(`${baseUrl}/deck/holdings`)
  ...
  await page.goto(`${baseUrl}/deck/transactions`)
  ...
  await page.goto(`${baseUrl}/deck/income`)
  ...
  await page.goto(`${baseUrl}/deck/tax`)
  ...
  await page.goto(`${baseUrl}/deck/settings`)
  ...
  await mobilePage.waitForURL('**/deck')
  ...
  check('mobile holdings route', mobilePage.url().endsWith('/deck/holdings'))
