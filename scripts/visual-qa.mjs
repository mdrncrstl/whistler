...
try {
  ...
  check('demo route', page.url().endsWith('/workspace'))
  ...
  await page.goto(`${baseUrl}/workspace/holdings`)
  ...
  await page.goto(`${baseUrl}/workspace/transactions`)
  ...
  await page.goto(`${baseUrl}/workspace/income`)
  ...
  await page.goto(`${baseUrl}/workspace/tax`)
  ...
  await page.goto(`${baseUrl}/workspace/connections`)
  ...
  await mobilePage.waitForURL('**/workspace')
  ...
  check('mobile holdings route', mobilePage.url().endsWith('/workspace/holdings'))
