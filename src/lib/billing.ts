export const billingPlans = [
  ...
  { id: 'standard', stripePlan: 'investor', name: 'Investor', portfolios: 3, annual: 17.5, annualTotal: 210, monthly: 23.8, navexaAnnual: 25, navexaMonthly: 34, featured: true, features: ['Everything in Essential', 'Unrealised CGT planning', 'Diversification and income calendar', 'Custom holding groups'] },
  { id: 'premium', stripePlan: 'private_wealth', name: 'Private Wealth', portfolios: 10, annual: 28, annualTotal: 336, monthly: 37.8, navexaAnnual: 40, navexaMonthly: 54, featured: false, features: ['Everything in Investor', 'Up to 10 portfolios', 'Portfolio summaries', 'Priority data support'] },
] as const
