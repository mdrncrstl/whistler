...
export const marketingPages = [
  page('/features/portfolio-tracking','Portfolio tracking','Features','Your investments, in one working view.','Holdings, cash and transactions in one view.',[
  ...
  page('/features/performance','Performance & benchmarks','Features','Understand what contributed to your return.','See what drove your return.',[
  ...
  page('/features/income','Dividends & income','Features','Keep your investment income in view.','Track dividends and distributions.',[
  ...
  page('/features/australian-tax','Australian tax records','Features','Keep tax time connected to your trades.','Keep CGT and tax records connected.',[
  ...
  page('/features/integrations','Connections & imports','Features','Bring in your records. Keep your broker.','Brokers, CSVs and PDFs in one history.',[
  ...
  page('/features/portfolio-assistant','Portfolio assistant','Features','Ask a question. Follow the numbers.','Ask about your portfolio and holdings.',[
  ...
  page('/for/share-investors','Share investors','Who it’s for','A clearer record of the shares you own.','Track shares, trades and performance together.',[
  ...
  page('/for/etf-investors','ETF investors','Who it’s for','Keep your ETF portfolio easy to follow.','See funds, distributions and performance together.',[
  ...
  page('/for/multiple-portfolios','Multiple portfolios','Who it’s for','Separate accounts. One place to review them.','Keep accounts and strategies in one view.',[
  ...
  page('/company/help','Help centre','Company','Get your first portfolio into shape.','Practical steps for getting started.',[
