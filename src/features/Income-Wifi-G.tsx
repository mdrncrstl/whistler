...
export function Income() {
  ...
  const assetMarkets = rows.reduce((map, item) => {
    const key = item.symbol || 'Cash'
    if (!map.has(key)) map.set(key, item.market)
    return map
